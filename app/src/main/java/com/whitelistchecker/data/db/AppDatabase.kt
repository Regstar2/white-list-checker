    ...
    companion object {
        ...
        private val MIGRATION_6_7 = object : Migration(6, 7) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    """
                    CREATE TABLE IF NOT EXISTS pending_public_reports (
                ...
                db.execSQL(
                    "CREATE INDEX IF NOT EXISTS index_pending_public_reports_createdAtMillis ON pending_public_reports(createdAtMillis)",
                )
            }
        }
